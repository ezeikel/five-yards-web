...
import { faUser, faShoppingBag, faHeart, faBox, faExchangeAlt, faCommentAlt} from '@fortawesome/free-solid-svg-icons';
...
library.add(fab, faUser, faShoppingBag, faHeart, faBox, faExchangeAlt, faCommentAlt);
